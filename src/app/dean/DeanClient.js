    ...
    <Shell role="DEAN" name={me.name} nav={NAV}>
      ...
      <Modal open={showDept} onClose={() => setShowDept(false)} title="Add Department">
        <form onSubmit={createDept} className="space-y-3">
          <Field label="Department name"><input className="input" required onChange={(e) => setForm({ ...form, name: e.target.value })} /></Field>
          <Field label="Code (e.g. CSE)"><input className="input" required onChange={(e) => setForm({ ...form, code: e.target.value })} /></Field>
          <div className="grid grid-cols-2 gap-3">
            ...
            <Field label="Duration (yrs)"><input className="input" type="number" onChange={(e) => setForm({ ...form, durationYears: e.target.value })} /></Field>
            <Field label="Intake"><input className="input" type="number" onChange={(e) => setForm({ ...form, intake: e.target.value })} /></Field>
          </div>
