...
async function main() {
  ...
  const students = [
    { registrationNo: '2201CSE001', name: 'Aarav Sahoo', email: 'aarav@cutm.ac.in', latestCGPA: 8.4, liveBacklogs: 0, attendancePercent: 88, riskLevel: 'LOW', currentSemester: 6, batch: '2022-2026', onTimeGraduation: true, attainments: [{ academicYear: '2025-26', course: 'CO1', coAttainment: 2.6, poAttainment: 2.5 }], parentEmail: 'parent.aarav@example.com', placements: [{ type: 'PLACEMENT', company: 'TCS', ctcLPA: 4.5, status: 'ACCEPTED' }] },
    { registrationNo: '2201CSE002', name: 'Diya Patra', email: 'diya@cutm.ac.in', latestCGPA: 6.1, liveBacklogs: 2, attendancePercent: 68, riskLevel: 'HIGH', currentSemester: 6, batch: '2022-2026', onTimeGraduation: false, attainments: [{ academicYear: '2025-26', course: 'CO1', coAttainment: 1.2, poAttainment: 1.1 }], parentEmail: 'parent.diya@example.com' },
    { registrationNo: '2201CSE003', name: 'Ishaan Rout', email: 'ishaan@cutm.ac.in', latestCGPA: 9.1, liveBacklogs: 0, attendancePercent: 93, riskLevel: 'LOW', currentSemester: 6, batch: '2022-2026', onTimeGraduation: true, attainments: [{ academicYear: '2025-26', course: 'CO1', coAttainment: 2.9, poAttainment: 2.8 }], parentEmail: 'parent.ishaan@example.com', placements: [{ type: 'HIGHER_STUDIES', institution: 'IIT', programme: 'M.Tech', status: 'ACCEPTED' }] },
    { registrationNo: '2501CSE014', name: 'Kiara Mohanty', email: 'kiara@cutm.ac.in', latestCGPA: 7.8, liveBacklogs: 0, attendancePercent: 90, riskLevel: 'LOW', currentSemester: 1, batch: '2025-2029', onTimeGraduation: true, attainments: [{ academicYear: '2025-26', course: 'CO1', coAttainment: 2.0, poAttainment: 2.0 }], parentEmail: 'parent.kiara@example.com' },
  ];
